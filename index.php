...
<head>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
        // Send an asynchronous request to track_visitor.php
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "track_visitors.php", true);
        xhr.send();
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">COVID REGISTRY</a>
  ...
  <header class="bg text-white" style="background-color: blue;">
    <div class="container text-center" >
      <h1>COVID19 Symptoms & Preventions</h1>
    </div>
  </header>
  ...
  <!-- Footer -->
  <footer class="py-5 bg-black-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Indian Gov</p>
    </div>
    <!-- /.container -->
  </footer>
