...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "insert into tbltestrecord(PatientMobileNumber,Vaccine,TestTimeSlot,OrderNumber) values('$mnumber','$Vaccine','$timeslot','$orderno');";
...
?>
    ...
    <head>
        ...
        <title>Covid-19 | B/w Dates Report Date Selection</title>
