                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total visitors
                                                    </div>
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col-auto">
                                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                                <?php
                                                                // Count the total number of user-side visitors
                                                                $queryTotalVisitors = mysqli_query($con, "SELECT COUNT(id) AS total_visitors FROM tblvisitors");
                                                                $rowTotalVisitors = mysqli_fetch_assoc($queryTotalVisitors);
                                                                $totalVisitors = $rowTotalVisitors['total_visitors'];

                                                                // Check for the latest timestamp to ensure real-time data
                                                                $queryLatestTimestamp = mysqli_query($con, "SELECT MAX(timestamp) AS latest_timestamp FROM tblvisitors");
                                                                $rowLatestTimestamp = mysqli_fetch_assoc($queryLatestTimestamp);
                                                                $latestTimestamp = $rowLatestTimestamp['latest_timestamp'];
                                                                echo $totalVisitors;
                                                                ?>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                    $queryTotalUsers = mysqli_query($con, "SELECT COUNT(DISTINCT unique_id) AS total_users FROM tblregistration");
