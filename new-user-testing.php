...
if (isset($_POST['submit'])) {
    ...
    $state = $_POST['state'];
    // $vaccines = $_GET['vaccine'];
    $vaccines = $_POST['vaccine'];
    $timeslot = $_POST['birthdaytime'];
    $orderno = mt_rand(100000000, 999999999);
    $centers = $_POST['center'];

    // To see the registered user
    $userIdentifier = uniqid();
    $_SESSION['user_identifier'] = $userIdentifier;
    $insertSlotQuery = "INSERT INTO tblregistration (unique_id) VALUES ('$userIdentifier')";
    mysqli_query($con, $insertSlotQuery);

    $query1 = "INSERT INTO tblpatients(FullName, MobileNumber, DateOfBirth, GovtIssuedId, GovtIssuedIdNo, FullAddress, State, center) VALUES ('$fname', '$mnumber', '$dob', '$govtid', '$govtidnumber', '$address', '$state', '$centers')";

    $query_vac = "INSERT INTO tbltestrecord (PatientMobileNumber, Vaccine, TestTimeSlot, OrderNumber) VALUES ('$mnumber', '$vaccines', '$timeslot', '$orderno')";

    if ($result_vac = mysqli_query($con, $query_vac)) {
        echo $vaccines;
    }
...
<head>
    ...
    <title>Covid-19 | New User Testing</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Covid19-Testing</h1>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="vaccine" name="vaccine" required="true">
                                                <option value="">Select</option>
                                                <?php
                                                $query3 = "SELECT vaccine_name FROM tblvaccine";
                                                $result3 = mysqli_query($con, $query3);
                                                while ($row = mysqli_fetch_assoc($result3)) {
                                                    echo "<option value='" . $row['vaccine_name'] . "'>" . $row['vaccine_name'] . "</option>";
                                                }
                                        ...
                                        <div class="form-group">
                                            <label>Vaccinations Centers</label>
                                            <select class="form-control" id="center" name="center" required="true">
                                                <option value="">Select</option>
                                                <?php
                                                $query4 = "SELECT center_name FROM tblcenter";
